...
def require_login():
    if 'username' not in login_session:
        flash("Please login to add and update the list.")
        return redirect('/')
...
def google_connect(request):
    ...
    print('Verify that the app state token is valid: {}'.format(login_session['state']))
    ...
    print('Verify that the credentials access token is valid: {}'.format(credentials.access_token))
    ...
    print('Verify that the access token is valid for this app: {}'.format(GOOGLE_CLIENT_ID))
...
def facebook_connect(request):
    ...
    try:
        ...
        # Verify that the access token is valid for this app.
        FACEBOOK_APP_ID = json.loads(open('fb_client_secrets.json', 'r').read())['web']['app_id']
        FACEBOOK_APP_SECRET = json.loads(open('fb_client_secrets.json', 'r').read())['web']['app_secret']
        print('Verify that the access token is valid for this app: {}-{}'.format(FACEBOOK_APP_ID, FACEBOOK_APP_SECRET))
